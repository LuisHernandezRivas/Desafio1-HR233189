...
CREATE TABLE tipo_clientes (
    idtipocliente INT PRIMARY KEY NOT NULL,
...
CREATE TABLE cliente (
    ...
    CONSTRAINT FK_cliente_tipo FOREIGN KEY (idtipocliente)
        REFERENCES tipo_clientes(idtipocliente)
);
GO

-- Insertar registros de los clientes
...
CREATE TABLE facturacion (
    idfacturacion INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
    idcliente INT NOT NULL,
    monto_facturacion DECIMAL(10,2) NOT NULL,
    CONSTRAINT FK_facturacion_cliente FOREIGN KEY (idcliente)
        REFERENCES cliente(idcliente)
);
GO

-- Insertar registros de las facturaciones
SET IDENTITY_INSERT facturacion ON;
...
(79, 23670, 120.90),
(80, 47693, 44.90);
SET IDENTITY_INSERT facturacion OFF;
GO