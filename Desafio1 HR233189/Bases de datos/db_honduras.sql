...
CREATE TABLE ClientesProcesados (
    idcliente INT PRIMARY KEY,
    codigo_pais VARCHAR(2) NOT NULL,
    codigo_cliente NVARCHAR(15) NOT NULL,
    nombres VARCHAR(250),
...
insert into cliente values (47715,3,'sv-hg47715','038162064','06142410871140','HERNANDEZ MEMBRE�O','GUSTAVO RAFAEL','m','71048822','t');
...
insert into cliente values (9278,2,'sv-nm9278','000900886','06142712600140','NU�EZ GRANADOS','MANUEL VICENTE','m','61317133','f');
...
insert into cliente values (1054,1,'sv-sm1054','024082919','02030510681014','SALAZAR DE SERME�O','MARITZA CAROLINA','f','64478435','t');
